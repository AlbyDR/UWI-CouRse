...
#'
#' [^1]: non*compulsory module with a duration of 2x45 minutes offers to help      
...
#'*	What is still missing: *an overview of uncovering subjects such as spatial Analysis and DOE*
#'
#'**Workshop**
