...
A variable is a quantity or quality that you can measure. The distribution of a variable will depend on whether the variable is categorical, discrete or continuous. <span style="color: red;">text</span>
