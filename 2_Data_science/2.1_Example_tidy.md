...
$ `\textcolor{green}{ \text{ Eq.(3-5) in the main text} } `$

Within an inline equation

$ `red red`$

add a colored text block with

\textcolor{ red }{ \text{ Your text cccccaas   } }
...
A variable is a quantity or quality that you can measure. The distribution of a variable will depend on whether the variable is categorical, discrete or continuous.<span color="red">red</span>

![](data_science_fig/data_science_Fig1.png)<!-- -->

## <h3 style="color:#ff0000"> Example 2.1 Tidy Data </h3>

# ![red]TYPE OF VARIABLE
