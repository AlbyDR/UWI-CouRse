...
&nbsp;
![](data_science_fig/data_science_Fig1.png)<!-- .element height="5%" width="5%" -->
&nbsp;
&nbsp;
&nbsp;
#
...
&nbsp;
![](data_science_fig/data_science_Fig2.png){:height="50%" width="50%"}<!-- -->
#
&nbsp;
&nbsp;
&nbsp;
## DATA SCIENCE WITH R
![](data_science_fig/data_science_Fig3n.png)<!-- -->
&nbsp;
&nbsp;
&nbsp;
## DATA PROCESSING
