...
#'
#' VG          Sealing, track ballast is considered sealed (% of area size)
#' VG_0        Sealing, track ballast is considered unsealed (% of area size)
#' PROBAU      Built-up sealed area (% of area size)
#' PROVGNEU    Sealed area undeveloped, track ballast is considered sealed (% of area size)
#' PROVGNEU_0  Unbuilt sealed area, track ballast is considered unsealed (% of area size)
#'
